...
## Joueur contre joueur (PVP) : Mode Challenge & Hardcore
<img src="medias/img_8.png" width="100" height="100">

## Système d'arènes
<img src="medias/img_9.png" width="100" height="100">

## Les donjons et autres instances
...
Le jeu est prévu pour avoir plusieurs factions. Les Humains, les Elfes, les Nains et les Orcs entretiennent tous des liens amicaux les uns envers les autres, mais il y a d'autres… races qui veulent leur peau. Il existe également des factions basées sur les classes de jeu.

## Les montures
<img src="medias/img_12.png" width="100" height="100">

Sellez votre cheval ou votre dragon et parcourez le monde. Peut-être obtiendrez-vous des pouvoirs supplémentaires lorsqu'il est monté ? 🙂

## Les animaux de compagnie
<img src="medias/img_13.png" width="100" height="100">

Invoquez des animaux de compagnie de combat ou non, définissez son comportement comme agressif, défensif, passif, suivez le maître, attaquez, etc. Vous pouvez les invoquer en utilisant un objet ou une capacité.

## La place de marché (marketplace)
<img src="medias/img_14.png" width="100" height="100">

La place de marché vous permet de publier des objets à vendre (pour la monnaie du jeu ou de l'argent réel) et de trouver des objets en utilisant la recherche et en filtrant par grade, classe, race et niveau, pour enfin l'acheter à la vente aux enchères.

## La maison du mint
<img src="medias/img_15.png" width="100" height="100">

La maison du mint vous permet de minter des objets rares et de les vendre sur le marché pour de l'argent réel.

## Votre inventaire
<img src="medias/img_16.png" width="100" height="100">

Ouvrez votre/vos sac(s) à dos et accédez à l'inventaire de votre personnage : armes (main principale, main libre, deux mains), armures (gants, bottes, casque, plastron, pantalon, épaulettes), bijoux (collier, boucles d'oreilles, bagues) et munitions pour arcs ou pistolets. Vous pouvez empiler des objets, définir la quantité de sacs, leurs emplacements, etc.
...
Chaque objet peut être associé à des sockets pour obtenir des effets supplémentaires à partir de matériaux socketable.

## Le système de loot
<img src="medias/img_20.png" width="100" height="100">

Les objets de butin sont attachés aux monstres. 
Les objets de quête ne seront pas dropés pour le joueur qui n'a pas lancé la quête nécéssaire. 
Il existe deux systèmes de butin (traditionnel avec distribution de butin au sein du groupe et personnel pour chaque joueur)
